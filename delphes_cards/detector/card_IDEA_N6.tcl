...
set ExecutionPath {
  ...
  GenJetFinderDurhamN6
  FastJetFinderDurhamN6
  FastCaloJetFinderDurhamN6
...
module FastJetFinder GenJetFinderDurhamN4 {
...
module FastJetFinder GenJetFinderDurhamN6 {
...
module FastJetFinder FastJetFinderDurhamN4 {
#  set InputArray Calorimeter/towers
  set InputArray EFlowMerger/eflow
...
module FastJetFinder FastJetFinderDurhamN6 {
#  set InputArray Calorimeter/towers
  set InputArray EFlowMerger/eflow
...
module FastJetFinder FastCaloJetFinderDurhamN6 {
  set InputArray Calorimeter/towers
  #set InputArray EFlowMerger/eflow
...
module TreeWriter TreeWriter {
    ...
    add Branch GenJetFinderDurhamN6/jets GenJetDurhamN4 Jet
    add Branch FastJetFinderDurhamN6/jets JetDurhamN4 Jet
